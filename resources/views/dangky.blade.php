            ...
            <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                ...
                <form action="{{route('register.post')}}" method="POST">
                    ...
                    <div class="form-outline mb-4">
                        <input type="text" name="hoten" id="form1Example13" placeholder="Họ tên"
                            class="form-control form-control-lg" />
                    </div>
                    <div class="form-outline mb-4">
                        <input type="text" name="diachi" id="form1Example13" placeholder="Địa chỉ"
                            class="form-control form-control-lg" />
                    </div>
                    <div class="form-outline mb-4">
                        <input type="text" name="sdt" id="form1Example13" placeholder="Số điện thoại"
                            class="form-control form-control-lg" />
                    </div>
                    <div class="form-outline mb-4">
